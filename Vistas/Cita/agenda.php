        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a id="citas_cliente" class="nav-link" onclick="abrirM(this.id)" href="#"><i
                                class="fa fa-calendar"></i> Citas</a>
                    </li>
                    <li class="nav-item">
                        <a id="team_cliente" class="nav-link" onclick="abrirM(this.id)" href="#"><i
                                class="fa fa-users"></i> Equipo D'Jane</a>
                    </li>
                    <li class="nav-item">
